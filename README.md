# 🛡️ ASTRACAT Cloud Admin Panel — Система управления VPN-бизнесом
...
![astracat-cloud](https://github.com/user-attachments/assets/e5c00d7c-58c1-447d-a539-6aa616856e0c)

## 🧪 [Тестовый сайт](https://panel.astracat-cloud.app/login)  ## 💬 **[Наш Чат](https://t.me/astracat-cloud_admin_panel)** - Для вопросов и предложений
## 📋 Содержание
...
**ASTRACAT Cloud VPN** — это комплексное решение для запуска и управления VPN-бизнесом. Система включает:
...
YOUR_SERVER_IP=https://panel.astracat-cloud.app
...
└── instance/                   # Экземпляр приложения (БД, кэш)
    ├── astracat-cloud.db           # SQLite база данных
    └── cache/                  # Кэш файлов
```
...
- **Email:** admin@astracat-cloud.app
- **Telegram:** @StealthNet_Admin

## 📄 Лицензия

Этот проект является частью ASTRACAT Cloud VPN системы.
...
**ASTRACAT Cloud VPN** — Ваша свобода в цифровом мире 🛡️
